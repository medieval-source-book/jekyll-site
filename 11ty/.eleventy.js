...
module.exports = function(eleventyConfig) {
  ...
  // Since input is "..", globs should be relative to that input directory
  eleventyConfig.addCollection("texts", function(collectionApi) {
    return collectionApi.getFilteredByGlob(["../_texts/**/*.md", "../_texts/**/*.html"]);
  });
  eleventyConfig.addCollection("textcollections", function(collectionApi) {
    return collectionApi.getFilteredByGlob(["../_textcollections/**/*.md", "../_textcollections/**/*.html"]);
  });
  eleventyConfig.addCollection("languages", function(collectionApi) {
    return collectionApi.getFilteredByGlob(["../_languages/**/*.md"]);
  });
  eleventyConfig.addCollection("periods", function(collectionApi) {
    return collectionApi.getFilteredByGlob(["../_periods/**/*.md"]);
  });
  eleventyConfig.addCollection("genres", function(collectionApi) {
    return collectionApi.getFilteredByGlob(["../_genres/**/*.md"]);
  });
  ...
  return {
    dir: {
      input: "..",              // repository root for content files
